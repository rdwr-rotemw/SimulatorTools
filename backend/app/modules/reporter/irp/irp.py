...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog='Examples:\n'
               ...
               '  python irp.py -m 7 -src 10.218.101.38 -dst 172.17.40.1 -v values/message_7.json -x data_formats/IdsDataFormat100600.xml\n\n'
               '  # Send messages continuously for 60 seconds:\n'
               '  python irp.py -m 38 -src 192.168.1.100 -dst 192.168.1.200 -v values/message_38.json -x data_formats/IdsDataFormat82200.xml -t 60\n\n'
               '  # Send multiple messages from a JSON file:\n'
               '  python irp.py -f messages/multiple_messages.json -src 10.0.0.1 -dst 10.0.0.2 -x data_formats/IdsDataFormat100600.xml\n\n'
               '  # Send multiple messages continuously for 120 seconds:\n'
               '  python irp.py -f messages/batch_messages.json -src 192.168.1.100 -dst 192.168.1.200 -x data_formats/IdsDataFormat100600.xml -t 120\n\n'
               '  # Create a JSON template for message ID 7:\n'
               '  python irp.py -c 7 -x data_formats/IdsDataFormat100600.xml\n\n'
               '  # Create an interactive template (choose array sizes):\n'
               '  python irp.py -c 7 -i -x data_formats/IdsDataFormat100600.xml\n\n'
               '  # Create a template with custom output file:\n'
               '  python irp.py -c 38 -x data_formats/IdsDataFormat82200.xml -o templates/my_message_38.json\n\n'
