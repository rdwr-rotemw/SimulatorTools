                        ...
                        <Paper sx={{p: 3, height: '100%'}}>
                            ...
                            <Alert severity="warning" sx={{mb: 3}}>
                                ...
                                <Typography variant="body2">
                                    This feature replaces the production IdsDataFormat XML used by CyberController for
                                    the selected simulator version.
                                    Only use this for development and testing purposes. The original XML will be
